...
def home(request):
    ...
    return render(request, 'gallery.html', {'title':title, 'images':images, 'image_locations':image_locations})
...
def single_image(request,image_id,cat_name):
    ...
    title = f'{cat_name}'
    return render(request,"pic.html",{'title':title, 'image':image, 'image_cat':image_cat, 'image_locations':image_locations})
